...
#define ZERO_X	1.25 //accleration of X-AXIS is 0g, the voltage of X-AXIS is 1.22v
#define ZERO_Y	1.23 //
#define ZERO_Z	0.20 //
#define SENSITIVITY 0.25//sensitivity of X/Y axis is 0.25v/g
#define SENSITIVITYx 0.03//sensitivity of Z axis is 0.03v/g
...
public:
	...
	void getPitchAndRoll(float *roll, float *pitch);
};
